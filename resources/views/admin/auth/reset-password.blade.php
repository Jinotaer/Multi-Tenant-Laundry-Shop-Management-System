<x-admin-guest-layout>
    ...
    <div class="mb-6 text-center">
        ...
        <h2 class="text-xl font-bold tracking-tight text-gray-900">Reset your password</h2>
        <p class="mt-1 text-sm text-gray-500">Choose a strong new password for your account</p>
    </div>
