<x-admin-guest-layout>
    ...
    <div class="mb-6 text-center">
        ...
        <h2 class="text-xl font-bold tracking-tight text-gray-900">Admin Portal</h2>
    ...
    <form method="POST" action="{{ route('admin.login') }}" class="space-y-4">
        ...
        <div class="flex items-center justify-between">
            ...
            <a
                ...
                class="text-sm font-medium text-indigo-600 hover:text-indigo-500 transition-colors duration-150"
            >
                {{ __('Forgot password?') }}
            </a>
        </div>
