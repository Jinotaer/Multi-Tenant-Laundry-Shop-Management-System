                ...
                <form method="POST" action="{{ route('tenant.inventory.update', $item) }}" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="category" required value="{{ old('category', $item->category) }}"
                    ...
                    <div>
                        ...
                        <input type="text" name="unit" required value="{{ old('unit', $item->unit) }}"
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="number" name="quantity_on_hand" required step="0.01" min="0"
                        ...
                        <div>
                            ...
                            <input type="number" name="reorder_level" required step="0.01" min="0"
                    ...
                    <div>
                        ...
                        <textarea name="description" rows="3"
                            class="block w-full rounded-md border-gray-300 shadow-sm text-sm @error('description') border-red-300 @enderror">{{ old('description', $item->description) }}</textarea>
