        ...
        <div class="mt-6 space-y-5">
            ...
            <div>
                ...
                <input type="text" name="name" value="{{ old('name') }}" required
                    ...
                    class="block w-full rounded-md {{ $errors->has('name') && old('form_context') === 'service-create' ? 'border-red-300' : 'border-gray-300' }} shadow-sm text-sm">
            ...
            <div>
                ...
                <textarea name="description" rows="2" placeholder="Brief description of this service..."
                    class="block w-full rounded-md border-gray-300 shadow-sm text-sm">{{ old('form_context') === 'service-create' ? old('description') : '' }}</textarea>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="number" name="price" value="{{ old('form_context') === 'service-create' ? old('price') : '' }}" min="0" step="0.01" required
                        placeholder="0.00"
                        class="block w-full rounded-md {{ $errors->has('price') && old('form_context') === 'service-create' ? 'border-red-300' : 'border-gray-300' }} shadow-sm text-sm">
