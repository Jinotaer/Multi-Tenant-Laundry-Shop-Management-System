            ...
            <div class="p-6">
                <form method="POST" action="{{ route('tenant.expenses.update', $expense) }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="description" required value="{{ old('description', $expense->description) }}" class="block w-full rounded-md border-gray-300 shadow-sm text-sm @error('description') border-red-300 @enderror">
                    ...
                    <div>
                        ...
                        <input type="number" name="amount" required step="0.01" min="0.01" value="{{ old('amount', $expense->amount) }}" class="block w-full rounded-md border-gray-300 shadow-sm text-sm @error('amount') border-red-300 @enderror">
                    ...
                    <div>
                        ...
                        <input type="date" name="expense_date" required value="{{ old('expense_date', $expense->expense_date->format('Y-m-d')) }}" class="block w-full rounded-md border-gray-300 shadow-sm text-sm @error('expense_date') border-red-300 @enderror">
                    ...
                    <div>
                        ...
                        <textarea name="notes" rows="3" class="block w-full rounded-md border-gray-300 shadow-sm text-sm">{{ old('notes', $expense->notes) }}</textarea>
