<x-tenant-layout>
    ...
    <div class="space-y-6">
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6">
                <h3 class="text-lg font-semibold text-gray-900 mb-1">Shop Logo</h3>
                <p class="text-sm text-gray-500 mb-6">Upload your shop's logo. It will appear in the sidebar.</p>

                <div class="flex items-start gap-6">
                    <!-- Current Logo Preview -->
                    <div class="flex-shrink-0">
                        @if ($logoUrl)
                            <img src="{{ $logoUrl }}" alt="Shop Logo" class="h-16 w-16 rounded-lg object-contain border border-gray-200 bg-white p-1">
                        @else
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6">
                ...
                <p class="text-sm text-gray-500 mb-6">Choose a color theme for your shop panel.</p>

                <form method="POST" action="{{ route('tenant.settings.theme.update') }}">
                    @csrf
                    @method('PATCH')
