            ...
            <form method="POST" action="{{ route('tenant.settings.paymongo.update') }}" class="p-6 space-y-6">
                ...
                <div>
                    ...
                    <input 
                        ...
                        class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm dark:border-slate-600 dark:bg-slate-700 dark:text-slate-100"
                    >
                ...
                <div class="rounded-lg border p-4" style="background-color: var(--tenant-theme-accent-soft); border-color: var(--tenant-theme-accent);">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex gap-3">
                            <div class="flex-shrink-0 w-6 h-6 rounded-full bg-green-600 text-white flex items-center justify-center" aria-hidden="true">
