<x-tenant-guest-layout>
    <div class="mb-6 text-center">
        ...
        <h2 class="text-xl font-bold tracking-tight text-gray-900 dark:text-slate-100">Set your customer password</h2>
        <p class="mt-1 text-sm text-gray-500 dark:text-slate-400">Choose a secure password to finish activating your customer account.</p>
    </div>
    ...
    <div class="mt-6 flex items-center gap-3">
        ...
        <span class="text-xs uppercase tracking-[0.22em] text-gray-400 dark:text-slate-500">secure access</span>
        <div class="flex-1 border-t border-gray-200 dark:border-slate-800"></div>
    </div>
