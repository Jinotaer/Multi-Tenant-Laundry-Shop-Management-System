...
<head>
    ...
    <title>Update Center {{ $release->version_tag }}</title>
    <style>
        :root {
            color-scheme: dark;
            --bg: #081123;
        ...
        * { box-sizing: border-box; }
        ...
        .eyebrow-dot {
            ...
            border-radius: 999px;
            background: var(--warn);
            box-shadow: 0 0 12px rgba(244, 183, 64, 0.7);
        }
    ...
    <div class="shell">
        <div class="topbar">
            <div>
                ...
                <h1>{{ $shopName }} is updating to {{ $release->version_tag }}</h1>
                <p class="subtitle">
                    This page stays outside the normal tenant layout so it keeps working while files and frontend assets are being replaced.
                </p>
            </div>

            <a href="{{ route('tenant.updates.status', $release->id) }}" class="button">View Live Status</a>
        </div>
        ...
        <div class="grid">
            <section class="panel">
                <div class="panel-body">
                    ...
                    <div class="meta" id="network-hint">
                        Keep this tab open. It will automatically finish and return to the normal Update Center when the update completes.
                    </div>
        ...
        (() => {
            ...
            function poll() {
                fetch(POLL_URL, {
                    ...
                    .then((data) => {
                        failedFetches = 0;
                        networkHint.textContent = 'Keep this tab open. It will automatically finish and return to the normal Update Center when the update completes.';
                        renderStatus(data);
